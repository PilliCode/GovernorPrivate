// Verification Key Hash: 31fca594f4ba84bbbf599a1c626820bd23a75e93fd09dbe014d3f79d731cfc2a
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0x31fca594f4ba84bbbf599a1c626820bd23a75e93fd09dbe014d3f79d731cfc2a;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x2807e9e0fb75a4526709340767605def6fa64a3bed2f419e7037e143666284bd) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x24cb5d4cfceb8f6c7f61a0613801677a31dcbe09c1cbfc40609e7ff05298a204) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x2203ab1171dac4f49153ebd363543a9124deebe3c901118bf36e62638d5db97e) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x23ceedfbb229320daf40054866a620f5d57f9a5184d011412496d8e0882ba9f4) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x1b763331161ad210bdded497bf9dc46125d29522f16fdc9fe2294eebae8cd949) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x2ea4fdecdb03b300337986afce724d3800886f5e6bf6a6b919374390a85c32b6) // vk.Q3.y
            ...
            mstore(add(_vk, 0x180), 0x29298f0093ec65dfe7ec75508e1cdd9f6a114ab42272d1caa70eefd27f5322a3) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x2007e8dfd99e5a766a0664058c0a5d089c4847aebb4fb04c89884a327e090d33) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x1fb7fcdad914caa399c7c247ed499ac9c320c9b14bece98771c406b51cd7547c) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x0a70165ac76462c8adf4c9bff8beb456aa589af721ab95b74d5db5fc08930f5f) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x1bd2724253f43eee76b059346ee7ca34ffcea1435f79fda868062cde4ad16e6b) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x257c7e3f73d52d955c7529f32569e3955a098e29ae5fee5901fb54c536f3e21c) // vk.Q_ARITHMETIC.y
            ...
            mstore(add(_vk, 0x300), 0x26dc6a9837df57477ca08b16ec5e575a3836b9726a45cbe723b35e64dd98e4ab) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x0f806ea982e917b34a10b2c5f2c926b318f19b2ba831ed09c8f77892928564cc) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x043bf6c892e8ae5f5ec655abf7fc4d0c15bdf1c2e43e56b660a4080b85ccbef2) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x24402134b6a5ca9e743b52e73e0f1c0d672d5eb5d9a13db4a55b4379ef7bc555) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x03b82ed0af8dcd54d796252d14ffb45150819d3355d36423d9cbfeec5081e933) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x1055b2af6155801848cf8e412354d13b44b488e9f5fa65719310afbfe812939a) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x1067a10a7f8469c75c881bcff83bbe12705f24059171c291a85a866c9e51d2d0) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x0122903ff22c8c51527e2ac5dfc4f58f131ab8e8d329a9e5d2023591a8ff2c74) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x540), 0x1f0134a4542513cd0c94e5e414047d46ab5c7ec04dde730d4e97a794bb996245) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x2f3e2f7e17594d205dbd4a82df5fe652051d005e908edaf1997d9d78da85efd3) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x0427032561f74fc521677cc5813dcce4438677680fd702b77a832006cac3a166) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x0b7ab3b199b1bbe3b7fa6f711e920c6bc6bfbd90d3b7661d772d16816d19fb4a) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x0c22d7f817d0936b83518257e2c8fedae50b6566849dbc8d9bb49dd233aac96b) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x20a5468eba695405583b2a9a4fdf2471ad0f32be3697702324937d947091eee3) // vk.ID3.y

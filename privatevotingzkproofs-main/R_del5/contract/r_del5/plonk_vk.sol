// Verification Key Hash: 28028158f79d72a3c247b526efc0aeb042e3cfd7dff5d692b94d4588f80e2171
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0x28028158f79d72a3c247b526efc0aeb042e3cfd7dff5d692b94d4588f80e2171;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x1fa3ad6ad313d9f4ecd11415471f278bc1193e67c91d1e4ae782f3031c3ed5a7) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x168bb15ac32f48e0ef076d49dc9f00b2d5aafac778e3763ff3cc7e27f8c5ff2a) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x0c746077b22ae2e563b64dddb558e92a3bf11bc9fda96195aa913fb928b2cf66) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x059e5280afd5f8516c35185c11c9d0179df1339caf953da371474145c6bf34ea) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x21a4886087183a06b89cb835cd732b6fb063a94ee3232ce51f0481da7986e1b3) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x1d6713f804431b823e6ec76c20eaa5568eb2ad503a6e85e06e5b79ec1bc4e304) // vk.Q3.y
            ...
            mstore(add(_vk, 0x180), 0x04b68f9a5efcc88a92d4ad98f76b78995f31386f291985764d6e0096fab434e9) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x24c966b5d4cad8db9c66669ef6dde91cd43d8f5a27eaf513400834b0bbd4db1a) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x2bc44d427f1fd2b040194f521b8632bc2d82ec3294154bdf535a749f0b7a85aa) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x099c06600070f9018dae1a97c6967c9ebfdeaee6ff946dfc60a58fd10223d425) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x26e6c8f94888e906832fc1455a8947f67037a159756101b7ccf1a0d3b33feca1) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x2840265019abb640cbdce849d6b8a6beee5ff540e06382a4253968157c66c0d1) // vk.Q_ARITHMETIC.y
            ...
            mstore(add(_vk, 0x300), 0x2ce9891e2d4bd870da0d27893e2daecd42a19946b5660b29d642fbadafbf3535) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x0cebfc51ff78e093d6e1ce9a1b0990edab9b85d191049d9be3f9255ea7c3bc56) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x0f25230d0d4a384de92777fbe79230691026783680ed60a12c662fc16cbf7e57) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x28396f33eece9594287d274af356b159c832644d0ca4c303c24d9c62e856232e) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x2a0d70c26c34980a57299246cb215b0f7c8d1489806cf031429069c3d7310436) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x2feaa8c9b9cbafbf7eed0e5e19579d11a5cd0804b2e322e0c0e47710ef9dc772) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x14ec61d77196073a3203e806775ea7c73c667d74668ca4e69c8c7ade816d80b7) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x0ac1bf85c49b5e6a86aebbe89198373cb7c5c9eb4ab7e3ebdda9c98ad0dbf508) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x540), 0x14879c69151c79db048eaba11f16c8fbdf13d1f71b8dfca785d3c7b3234ab982) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x05dcf94cc551d1fc7d91820cefaecc915a8128497822b692f55cecc97fc01478) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x023d63f89c99f236109ff3744067f673f6e4e50fd8b0579ed45015a94c42dc49) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x07602a76254c9b95a94396c5cff99f55fbba0b20658916f7ab1cbec347509ad9) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x091e01ac4096b01e59c703445bf2e98fa943892bcc1ab17c97eb6c34d75476ab) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x0e83cb4ae0eca623803b2cc003e2862884a5ffebb9e6be938286562eba0dbddc) // vk.ID3.y

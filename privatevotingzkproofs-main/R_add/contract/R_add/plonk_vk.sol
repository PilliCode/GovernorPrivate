// Verification Key Hash: 75070832060590deab80b095d12b715d1360c5ded06c7e2350d20674332e4ed5
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0x75070832060590deab80b095d12b715d1360c5ded06c7e2350d20674332e4ed5;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x20461bad31547386b12a9f6e9a5d5a7a300131bffe0c147d38dc9f1eb9b5a0a1) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x274ea6c86b21f9d4dc1879ff8b155933dff68a283c1c1481735ce5a8a310282b) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x1c4948861227b2609c90204db13ced3bafcb4576f48f15c2fb8d1cd8e1f11ce9) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x243141ca31ace315839d125e5289359b387b4d560389d50004477cd3af7ddb42) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x174121f79639cf97c47b52de7db7c2804dcc12dab538eb51a80d919f0a136eef) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x1f5518280a77eaf895249790bb15a2450cdfc7f543e205dfda56920083107808) // vk.Q3.y
            ...
            mstore(add(_vk, 0x180), 0x0ed055eb1003ea7ad3b761ed43729b7e18e29569ae8efe50b57fd441dbf35f46) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x25840eb890fbb1415e9f57bf8ae8e24436771dfef290c6887c5b346d993ab5ba) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x05e7cb960f45fe30de3243a7149a5138b29d207dfcb6c541af9898a1f1688654) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x21f1b694323ce28d77641d637faf4d3730b1eba4606d59aeed84bffd8a5691d8) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x0ceac0be89f9d1f6d66e78a0ea704fe860da0e3c271b26147e174cd10a44e3da) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x04b02b223ddfae7831f14f2fac27ddca2584700b4d3f61a4d3fdd1c2cf71d0af) // vk.Q_ARITHMETIC.y
            ...
            mstore(add(_vk, 0x300), 0x19cff15ac7bc995e4a12abbb7dd17b2d50d42b21976b0083b2180da58b2fec3c) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x0ab397bd1e05f1a3859e2b69c3c8fd4f1f1f2ec09c33e08506643a23837fb075) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x0df544ff3c9d5853e44a6ff087de5fc0bd469be3d7573c4a35f69d06116d3256) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x255449567b176508e6cf1045cacc103e414b91a813ffd64111fc2f098f2ff393) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x1cae9d3daf085ab95475648d21998b2d9d9334056d0d5dfd18191785afbaf266) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x2cf511b07b5b8906ec0cc661dd9b39a2826656536fe3800ba5d4123550a1964b) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x054205d0f743c56492e378ff48df248f6049818a9a485599458293bdf669e032) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x0aa722b05087ed6d5ffad49ed1b04fe23f95e4793f2addf3cfc9022cd03a2eb7) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x540), 0x1be3b5a5b8fb0fe692ed215d21949520e80b6b43ec45b3d748f290ccef5aa173) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x1b51740d41d44fbf38d22404ad89e99f22b639c022804056b072129b640e1670) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x0404c523bed47866ef278bc5643a540aaedb8de5e45769a088726930857d8663) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x27eeb9f5dc6ca1eefb925f0a1381b78016d4c47d4cfeee47fd47c62e67da82bd) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x3058833fb54466b21016069ddcd88578a8ded82e918cafbf4a25a50807b75b4d) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x185f891919318a15b4a9c30b227bafe047bfc4b91f72edebddae5e7034abeb3a) // vk.ID3.y

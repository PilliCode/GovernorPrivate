// Verification Key Hash: 02382aba7c96bbbc2b56f41ec2cad18e01482b17ba55024134d2b6fed8b58d76
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0x02382aba7c96bbbc2b56f41ec2cad18e01482b17ba55024134d2b6fed8b58d76;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x1c7879cb4aca2a80a30e4a8619443c3c47ed280a2c1a3764f167ee2c8e5c02a8) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x21f836b144dac0bff8fffb4fe6eff01ed9514dbceabdf17427a76ca8730480da) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x2c22adaff83e9e0cdcc6390862b1f0b4d0565602a8be432dab8691c3de937dd6) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x04415a304a94b94a70ad3089237b9dc094991680ed18b788be3cfea0b7ded1c2) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x095e0a7e9caac46f63f9ffae6ca5cf2fe3c91606d381d77dbf32584635c9464d) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x1577f0af7f53ecbea53b0d5524eceeddeae182abfa8fef0e3d7818d4a2de9933) // vk.Q3.y
            ...
            mstore(add(_vk, 0x180), 0x28de9b57c13da4100ad8e3847b5fa0974a84a24e2b5140d977708b3723d12b45) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x22a85eeb1876db7076d276c5f14766a3f4e919396ebc73ec47881129915aba5a) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x19980d7361222683d4b9a4fad9cebaa0e2a7d13f65b8da347a17871b4beee5f2) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x2ef1097e2ded7fef10bf647fe1dd27b258936730767901ee501de63874854f92) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x0356ea786654a2aa94752a1033ca6d4f028e459551318ac82d291eb02ee4ab08) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x0d241e18ab61a0e19610dac1a3e38dd1564df6ca7574f8d6c3b7e9903918979d) // vk.Q_ARITHMETIC.y
            ...
            mstore(add(_vk, 0x300), 0x01d905f5b6e6bee451d4b55da9d3d535f9214e0ac564528b206154941dc55824) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x2b3d5e6232f0bd6747b500a0abb8ad2f9eeede001176ff9db80a52773f08a795) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x22153e26468ed06248de915d3f23c56a645eca15822dde38ce11d97b6850f089) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x00cc56f106c78e8346fc42d8cf6f3ea3e4701d7911b4a87a40b9de493ecf3015) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x04ee92f853c2c13aff356945834fb454b3edde4ec83d5430c261ab0ef9add94f) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x1acf910553f1f9ae0da23ba1da2a3396ba81ecbd05f8daf2a8efcaa4a7fa5695) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x08a0a79226579e2c9f03b981c2ebbe42f61aa6b338698aad0e07248df71a0929) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x09d00a7079ce4e3e79fd648ec18898368b1d94dc5db9bc3ae7d2ccc838d5bc3f) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x540), 0x0a933612b446b17618258258019b87636715ec2fef43adb4d23b17c275ec2d2e) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x107ca45b6d6d93cb35884f2cd2665c27adca58f9ddd75e02cc4cf3b9607960c2) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x2c6aba40d77206d16a9167363b245324ef9c8db1ed27c549a251e8e10c1cdbc2) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x1065809e0577a9a39ad2e93b2698fa0628b0e71f52b71ca4daa1d1ea3709318f) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x0c34fa1c0060b632c35c5c89e0ab5a055a06c781fc89d86a3d1a97f16a70b738) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x172c437b451159a25afd03d04ee3f9ff9e42c209ecc4265f84807e539d8208c3) // vk.ID3.y
